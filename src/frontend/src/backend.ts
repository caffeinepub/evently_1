...
export class Backend implements backendInterface {
    ...
    async bookEvent(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.bookEvent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createEvent(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: bigint, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateEvent(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: bigint, arg6: string): Promise<void> {
        if (this.processError) {
            try {
